...
Register User
    ...
    Input Text    xpath=//*[@id='form']/input[@placeholder='Name']    ${NAME}
    Input Text    xpath=//*[@id='form']/input[@placeholder='Email Address']    ${EMAIL}
    Click Element    xpath=//*[@id='form']/button[contains(text(), 'Signup')]
    ...
    Input Text    xpath=//*[@id='mobile_number']    ${MOBILENUMBER}
